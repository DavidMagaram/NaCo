...
\begin{figure}[H]
	\begin{minipage}[b]{0.5\linewidth}
		\centering
		\includegraphics[width=1\linewidth]{b2_output1}
		\caption{Diastance vs n Generations, with the mean in blue/orange and the standard deviation in light blue/orange over 10 samples. }
		\label{fig:b2output1}
	\end{minipage}\hfill
	\begin{minipage}[b]{0.35\linewidth}
		\centering
		\includegraphics[width=1\linewidth]{b2_output2}
		\caption{Best distance of EA and MA on both datasets.}
		\label{fig:b2output2}
	\end{minipage}\hfill
...
\begin{figure}[H]
	...
	\end{minipage}\hfill
	\begin{minipage}[c]{0.48\linewidth}
		On both datasets the MA reaches shorter distances within the 200-generation limit (Table \ref{tab:b2_ea_vs_ma}), and its low final standard deviation shows it consistently converges to the same solution across runs. On the other hand, the EA's spread indicates it still gets stuck in different local optima at the cut-off.
	\end{minipage}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{minipage}[c]{0.5\linewidth}
		There is an important caveat: Per generation, MA takes much more compute \& longer than EA. It is therefore not fair to compare them in this way.
	\end{minipage}
\end{figure}
