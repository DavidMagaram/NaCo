...
The .zip file includes the following files:   \texttt{experiments\_b1.py},
   \texttt{experiments\_b2.py},
   \texttt{plotting\_b1.py},
   \texttt{plotting\_b2.py},
   \texttt{partA.ipynb},
   \texttt{partB1.ipynb},
   \texttt{partB2.ipynb},
   \texttt{eil51.tsp}, and \texttt{file-tsp.txt}.
