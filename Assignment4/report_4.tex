...
\todo[inline]{Maybe add that they can work in discrete spaces/without gradient}
...
\todo[inline]{Also why 3 datasets don't we only have 2}
\begin{tabular}{ll}
\hline
\textbf{Parameter} & \textbf{Value} \\
\hline
...
In this section, we aim to explore whether 2-opt local search improves TSP performance beyond the extra compute it costs. We test on both 
