...
What is swarm intelligence? What the Boids model simulates?



* Swarm intelligence is a collective behavior that emerges from interactions between many simple agents. Agents such as fish and birds can exhibit complex behaviors like flocking, forming bird flocks, fish schools, and insect swarms. Because each individual follws a set of simple rules, this can lead to complex emerging group behaviors. 
* Craig Reynolds' Boids model is one of the most popular models of swarm intelligence (source?). It is based on 3 simples agent rules: alignment, cohesion, and separation. 
* The goal of this project is to implement the Boids model and explore the swarm behavior and how different parameters affect it. 
...
How the simulation works. Parameters used. Metrics measured.


The JavaScript framework was used to implement the two-dimensional Boids model. The model was defined on a square grid of 400x400 pixels with wrapped dimensions. 200 boids were randomly initialized, each moving at a constant speed. The position and direction of each boid were updated at each time step based on the three rules, and the used parameters in this project are displayed in Table~\ref{tab:params}.
