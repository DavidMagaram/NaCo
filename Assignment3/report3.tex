...
\begin{table}[h!]
    ...
    \begin{tabular}{lccccccc}
        \toprule
        \textbf{Criterion} & \textbf{$R_{\text{in}}$} & \textbf{$R_{\text{out}}$} & \textbf{Align} & \textbf{Cohes.} & \textbf{Sep.} & \textbf{Order} & \textbf{NN-dist} \\
        \midrule
        ...
        \bottomrule
    \end{tabular}
    \caption{Best parameter configurations at $t=300$ across 384 configurations (N=150, 3 repeats each). Best Order maximizes alignment, Best NN-dist minimizes average nearest-neighbor distance, and Best Ratio maximizes Order/NN-dist.}
