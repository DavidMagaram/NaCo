...
\begin{itemize}
	...
	\item \textbf{May 22 -- June 1; Continue Experiments \& Paper Drafting:} Continue with list of Experiments. Draft the Results, Discussion, and Conclusion sections of the paper. 
	\subitem \textit{Milestone: Project reaching maturity with a complete first draft by June 1.}
	\item \textbf{June 1 -- June 8; Finalizing \& Minor Tests:} Run any lingering minor experiments. Format the final paper, review against the grading criteria, and submit.
\end{itemize}
