...
\begin{itemize}
	...
	\item \textbf{April 20 -- April 27; Gradient Baseline \& Tuning:} Re-implement the white-box gradient-based attack from Randazzo et al. 
	(or a standard Projected Gradient Descent on the perturbation matrix). Concurrently, tune the CMA-ES hyperparameters (population size, 
