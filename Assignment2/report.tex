...
\caption{Computational cost breakdown and measured runtime for each chunk size with $r=5$. Despite having the fewest total matching windows, $n=7$ is the slowest, indicating that per-chunk overhead dominates.}
\end{figure}
