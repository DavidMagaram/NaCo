...
\begin{table}[H]
\centering
\caption{Optimized validation across both datasets (Chunked Training, $n=7$, $r=5$). This took 44:42min to run on the test machine (Processor: Intel i5-8365U; 16 GB RAM) including chunking.}
\begin{tabular}{l c c c}
\hline
\textbf{Dataset} & \textbf{Split 1} & \textbf{Split 2} & \textbf{Split 3} \\
\hline
\texttt{snd-cert} & 0.9774 & 0.9841 & 0.9748 \\
...
\begin{table}[H]
\centering
\caption{Optimized validation across both datasets (Chunked Training, $n=10$, $r=5$). This took 30:44min to run on the test machine (Processor: Intel i5-8365U; 16 GB RAM) including chunking.}
\begin{tabular}{l c c c}
\hline
\textbf{Dataset} & \textbf{Split 1} & \textbf{Split 2} & \textbf{Split 3} \\
\hline
\texttt{snd-cert} & 0.9728 & 0.9820 & 0.9838 \\
\texttt{snd-unm}  & 0.9804 & 0.9821 & 0.9846 \\
\hline
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Optimized validation across both datasets (Chunked Training, $n=15$, $r=5$). This took 25:48min to run on the test machine (Processor: Intel i5-8365U; 16 GB RAM) including chunking.}
\begin{tabular}{l c c c}
\hline
\textbf{Dataset} & \textbf{Split 1} & \textbf{Split 2} & \textbf{Split 3} \\
\hline
\texttt{snd-cert} & 0.9756 & 0.9832 & 0.9746 \\
