...
Obstacles were initialized with a target volume (V) of 150 pixels and volume constraint strength ($\lambda$V) of 500 to ensure they are static and do not deform. Their perimeter (P) was set to 10 with a strong perimeter constraint strength ($\lambda$P) 200, keeping their shape strongly constrained. To further prevent any movement, their act ($\lambda$act, Maxact) was set to 0. Additionally, the adhesion between obstacles and moving cells (Jobstacle-cell) was set to a 1000 to ensure moving cells do not stick to obstacles or penetrate them.
